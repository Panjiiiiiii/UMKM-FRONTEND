...
export default function History() {
  ...
  // Data Dummy
  const transactions = [
    { id: 1, name: "Budi Santoso", phone: "081234567890", date: "2025-02-20", total: "Rp 1.500.000", status: "Selesai" },
    { id: 2, name: "Ani Wijaya", phone: "082345678901", date: "2025-02-18", total: "Rp 2.300.000", status: "Pending" },
    { id: 3, name: "Siti Rahma", phone: "083456789012", date: "2025-02-22", total: "Rp 750.000", status: "Selesai" },
    { id: 4, name: "Doni Prasetyo", phone: "084567890123", date: "2025-02-19", total: "Rp 3.200.000", status: "Dibatalkan" },
    { id: 5, name: "Rina Puspita", phone: "085678901234", date: "2025-02-21", total: "Rp 1.100.000", status: "Selesai" },
  ];
